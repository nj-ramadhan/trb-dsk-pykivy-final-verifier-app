    ...
    def regular_get_data(self, dt):
        ...
        try:
            ...
            if(count_get_data > 0):
                ...
                dt_value_emission = 0.0 if db_antrian[2] == None else float(db_antrian[2])
                dt_flag_sideslip = int(db_antrian[3])
                dt_value_sideslip = 0.0 if db_antrian[4] == None else float(db_antrian[4])
                dt_flag_load = int(db_antrian[5])
                dt_value_load = 0.0 if db_antrian[6] == None or db_antrian[7] == None else float((db_antrian[6] + db_antrian[7]) / 2)
                dt_flag_brake = int(db_antrian[8])
                dt_value_brake = 0.0 if db_antrian[9] == None else float(db_antrian[9])
                dt_flag_speed = int(db_antrian[10])
                dt_value_speed = 0.0 if db_antrian[11] == None else float(db_antrian[11])
                dt_flag_hlm = int(db_antrian[12])
                dt_value_hlm = 0.0 if db_antrian[13] == None else float(db_antrian[13])
                dt_flag_slm = int(db_antrian[14])
                dt_value_slm = 0.0 if db_antrian[15] == None else float(db_antrian[15])
                dt_flag_wtm = int(db_antrian[16])
                dt_value_wtm = 0.0 if db_antrian[17] == None else float(db_antrian[17])
